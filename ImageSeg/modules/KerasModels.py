...
def unet(pretrained_weights = None,input_size = (320,208,3),nclass=14):
...
def unet_3D(input_size = (240,240,144,4),nclass=4):
	inputs = Input(input_size)
	...
	conv9 = Conv3D(nclass, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9)
	conv10 = Conv3D(nclass, 1, activation = 'softmax')(conv9)
